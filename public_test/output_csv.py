...
def out(log_file_path = 'log/preterm_2.log', csv_file_path = 'output.csv'):


    # Regular expression to match the log entries
    model_pattern = re.compile(r'(transformer-base|FCN-base)')
...
if __name__ == '__main__':
    out(log_file_path="./log1.log", csv_file_path="public.csv")